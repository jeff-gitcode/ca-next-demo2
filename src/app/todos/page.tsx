...
import { useDeleteTodo, useTodos } from './useTodo';
      ...
      {data?.map((todo: Todo) => (
        <div key={todo.id} className="p-4 my-2 rounded-md border-b leading-8">
          ...
          <div className="flex gap-3 justify-end">
            <Link className="bg-slate-200 text-black py-2 px-4 rounded-md text-sm uppercase font-bold" href={`/todos/${todo.id}`}>Edit</Link>
